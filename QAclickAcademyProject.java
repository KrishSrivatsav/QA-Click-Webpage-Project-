...
//		int rowcount = Table.findElements(By.xpath("//*[@id='product']/tbody/tr[2]")).size();
		int colcount = Table.findElements(By.xpath("//*[@id=\"product\"]/tbody/tr/td[3]")).size();
		System.out.println(colcount);
		for(int i=0; i<colcount; i++)
		{
//			System.out.println("price is:" +Table.findElements(By.xpath("//*[@id=\"product\"]/tbody/tr[2]/td[3]")).get(i).getText());
			String value = Table.findElements(By.xpath("//*[@id=\'product\']/tbody/tr/td[3]")).get(i).getText();
